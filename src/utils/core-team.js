export const teamMembers = {
    ...
    volunteers: [
      ...
      {
        id: 32,
        name: 'DIPTANSHU MINIM',
        position: 'Volunteer',
        image: '/core-team/Volunteer/Diptanshu.jpg',
        department: 'B.Tech, Production and Industrial Engineering',
        email: '',
        description: 'Diptanshu is skilled in organizing health camps and awareness programs. He has been instrumental in the success of several health-related initiatives.',
        social: {
          linkedin: '#',
          twitter: '#',
          instagram: '#'
      ...
      },
      {
        ...
        name: 'SHANU PRIYA',
        position: 'Volunteer',
        image: '/core-team/Volunteer/Shanu.jpg',
        department: 'B.Tech, Civil Engineering',
        email: '',
        description: 'Shanu is skilled in organizing health camps and awareness programs. He has been instrumental in the success of several health-related initiatives.',
        social: {
          linkedin: '#',
          twitter: '#',
          instagram: '#'
        ...
        name: 'ATUL ANAND',
        position: 'Volunteer',
        image: '/core-team/Volunteer/Atul.jpg',
        department: 'B.Tech, Engineering and Computational mechanics',
        email: '',
        description: 'Diptanshu is skilled in organizing health camps and awareness programs. He has been instrumental in the success of several health-related initiatives.',
        social: {
      ...
      },
      {
        ...
        name: 'SAKSHI KUMARI',
        position: 'Volunteer',
        image: '/core-team/Volunteer/Sakshi.jpg',
        department: 'B.Tech, Engineering and Computational mechanics',
        email: '',
        description: 'Sakshi is skilled in organizing health camps and awareness programs. He has been instrumental in the success of several health-related initiatives.',
        social: {
          linkedin: '#',
          twitter: '#',
          instagram: '#'
        ...
        position: 'Volunteer',
        image: '/core-team/Volunteer/kushagra.jpg',
        department: 'B.Tech, Production and Industrial Engineering',
        email: '',
        description: 'khusagra  is skilled in organizing health camps and awareness programs. He has been instrumental in the success of several health-related initiatives.',
        social: {
          linkedin: '#',
          twitter: '#',
          instagram: '#'
      ...
      {
        id: 37,
        name: 'DEBASHREE GANGULY',
        position: 'Volunteer',
        image: '/core-team/Volunteer/Debashree.jpg',
        department: 'B.Tech, PG CH CH',
        email: '',
        description: 'Debashree is skilled in organizing health camps and awareness programs. He has been instrumental in the success of several health-related initiatives.',
        social: {
          linkedin: '#',
          twitter: '#',
          instagram: '#'
      ...
      },
      {
        ...
        name: 'ASHNA KHATRI',
        position: 'Volunteer',
        image: '/core-team/Volunteer/Aashna.jpg',
        department: 'B.Tech, Civil  Engineering',
        email: '',
        description: 'Ashna is skilled in organizing health camps and awareness programs. He has been instrumental in the success of several health-related initiatives.',
        social: {
          linkedin: '#',
          twitter: '#',
          instagram: '#'
