...
>
  ...
  >
    ...
    <div className="container mx-auto md:px-24 flex items-center justify-between h-full relative z-10">
...
<img src="./logo/NSSlogo.webp" width={60} alt="" />
          </div>
        </NavLink>
      </motion.div>
    ...
    <div className="absolute bottom-0 left-0 right-0 h-0.5 overflow-hidden">
      ...
      <div className="md:hidden fixed -top-6 left-0 w-full bg-transparent px-4 py-3 z-50">
        <Link
          to="/"
