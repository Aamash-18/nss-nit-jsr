        ...
        <div className="relative bg-[#0a0a20]/80 backdrop-blur-lg rounded-2xl p-6 border border-blue-500/10 transition-all duration-500 group-hover:border-blue-500/30 overflow-hidden z-10">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-gray-400 text-sm mb-6">
              Electronics and Communication Engineering faculty leading the NSS unit at NIT Jamshedpur with dedication and vision.
            </p>
      ...
      >
        ...
        <div className="relative bg-[#0a0a20]/80 backdrop-blur-lg rounded-2xl p-6 border border-blue-500/10 transition-all duration-500 group-hover:border-blue-500/30 overflow-hidden z-10">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-gray-400 text-sm mb-6">
              B.Tech, Electronics and Communication Engineering student responsible for coordinating NSS activities and volunteer management.
            </p>
