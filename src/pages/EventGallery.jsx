  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      >
        ...
        {/* Navigation Bar */}
        <div className="absolute md:top-4 top-2 md:left-0 right-0 z-20 px-3 py-2 md:px-6 md:py-4 ">
        ...
        {/* Event Title Overlay */}
        <div className="absolute md:top-20 left-0 right-0 z-20 px-6 py-12 md:py-8 ">
          <div className="container mx-auto">
